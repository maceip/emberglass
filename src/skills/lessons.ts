...
// "bounce inbox-adjacent near-misses"). Blocks SEED their lessons; tuning runs can
// LEARN new ones. distill(family) renders them into compact guidance for feeding
...
// upsert by (family, id): a learned lesson can refine an earlier seed of the same id
