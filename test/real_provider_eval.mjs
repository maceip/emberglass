 ...
 *   (value = OAuth2 access token for the *dedicated test account only*, with calendar scope).
 ...
 *
 * Run:
 *   node test/real_provider_eval.mjs --provider=google --account=test-google-2026-xxx
 *   (optionally --token=... to override env)
 *
