...
await p.goto('http://localhost:8013/lorav.html');
const t0=Date.now(); while(Date.now()-t0<120000){ if(L.some(l=>l.includes('VWG DONE')||l.includes('VWG ERROR')))break; await p.waitForTimeout(500);} await b.close();
